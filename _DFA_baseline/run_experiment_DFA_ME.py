...
from create_dataset import create_image_sequence_dataset_sampling_ME
EXPERIMENTS_FOLDER = '../experiments_ME'
# -----------------------------------------------------------------------------
...
with TimeoutBlock(3600, f"{EXPERIMENTS_FOLDER}/{experiment_name}/results/DFA_timeout_log.txt"): # 1h timeout
    parser = LTLfParser()

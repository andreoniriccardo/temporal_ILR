...
from utils.create_dataset import create_complete_set_traces_one_true_literal, create_image_sequence_dataset
from utils.classifier import CNN_ME
EXPERIMENTS_FOLDER = "../experiments_baseline_ME"
...
train_traces_tf, test_traces_tf, train_traces, test_traces, train_acceptance_tr, test_acceptance_tr = create_complete_set_traces_one_true_literal(config.max_length_traces, alphabet, dfa, train_with_accepted_only=False,
...
train_img_seq, train_acceptance_img = create_image_sequence_dataset(train_data, config.num_symbols, train_traces,
                                                                                          train_acceptance_tr, print_size=True)
test_img_seq_hard, test_acceptance_img_hard = create_image_sequence_dataset(test_data, config.num_symbols,
                                                                                        test_traces,
